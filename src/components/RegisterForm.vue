...
<template>
  <div class="flex items-center justify-center mt-10">
    <form class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md space-y-6" @submit.prevent="register">
      ...
      <div>
        ...
        <input v-model="username" id="username" type="text" placeholder="Nhập tên của bạn"
    ...
    <div v-if="showPopup" class="fixed flex items-center justify-center z-50">
      ...
      <div class="relative bg-white p-6 rounded-3xl shadow-2xl text-center w-80 z-10">
        ...
        <p class="mt-2 text-gray-500 text-sm">Tự động chuyển trong {{ count }} giây...</p>
        <button @click="closePopup" class="mt-4 px-4 py-2 bg-yellow-400 rounded-lg hover:bg-yellow-500">
